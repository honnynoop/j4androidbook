...
public class RequestFromBillboardHot2 {
			...
			if(ss.contains(msg)){
				...
				while(true){
					if(imageurl.contains("chart-row__image")){
						...
						if(imageurl.contains("https://") && imageurl.contains(".jpg")){// 중요 수정 http-> https
						//if(imageurl.contains("images/pref_images")){
							break;
						}else{  // 중요 수정 http-> https
				...
				//System.out.println("??------"+imageurl);
				imageurl=imageurl.substring(imageurl.indexOf("https://"));   // 중요 수정 http-> https
	...
	public static void main(String[] args) {
		...
		String a="https://www.billboard.com/charts/hot-100/";       //http ->https
		rfw.getAllHtml(a);

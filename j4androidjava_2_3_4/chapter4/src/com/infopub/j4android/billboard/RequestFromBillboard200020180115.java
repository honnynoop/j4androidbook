...
public class RequestFromBillboard200020180115 {
	
	ArrayList<String> htmls=new ArrayList<String>();
	ArrayList<Billbaord> billbaords=new ArrayList<Billbaord>();
	public RequestFromBillboard200020180115() {
		htmls.clear();
		billbaords.clear();
	}
...
//			}else if(count>105){ break;}
	...
	public static void main(String[] args) {
		RequestFromBillboard200020180115 rfw=new RequestFromBillboard200020180115();

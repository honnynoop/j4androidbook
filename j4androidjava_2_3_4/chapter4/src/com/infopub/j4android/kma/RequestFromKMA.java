...
//				System.out.println(rm(f));
	...
	public static void main(String[] args) {
		//String [] datas2=new String [] { "2000-01-01",todate2(new Date()),"2" ,"999"};
        ...
        rfw.printToObject("earth"+endTm.replaceAll("-", "_")+".txt");
        rfw.printTocsv("earth"+endTm.replaceAll("-", "_")+"csv.txt");
